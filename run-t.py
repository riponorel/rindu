...
def run_bot(data_account, recover=1):
    ...
    try:
        ...
        judul = f"[-TRENDING-]— {kw} Onlyfans Video Original Link {kw} Video Viral On Social Media X Trending Now"
        link = f"https://apps.freeplayer.one/?title= CLICK HERE >> {kw}?ref=25C"
